...
PcbPtr createnullPcb()
{
    ...
    new_process_Ptr->arrivaltime = 0;
    new_process_Ptr->turnaround_time = 0;
    new_process_Ptr->waiting_time = 0;
    new_process_Ptr->initial_cpu_time = 0;
    new_process_Ptr->initial_priority = 0;
    new_process_Ptr->suspensions = 0;
    new_process_Ptr->total_quantums = 0;
    new_process_Ptr->termination_time = 0;
...
PcbPtr terminatePcb(PcbPtr p)
{
    ...
    else
    {
        kill(p->pid, SIGINT);
        int * statusPtr = NULL;
        waitpid(p->pid, statusPtr, WUNTRACED);
