...
void sleep_and_signal(int time_green, int min_interval, pthread_mutex_t *mutex, 
            pthread_cond_t *conditional_variable, pthread_cond_t *conditional_variable_2) {
    int time_green_function = time_green;
    while (time_green_function > 0) {
            //printf("time green %d\n", time_green_function);
            ...
            if (!signal_1 || !signal_2)  {
                ...
                if ((time_green_function - min_interval) < 0) {
                    sleep(time_green_function);
                    time_green_function = 0;
                } else {
                    sleep(min_interval);
                    time_green_function = time_green_function - min_interval;
                }
